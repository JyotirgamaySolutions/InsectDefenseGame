  ...
  english: [
    {
      ...
      defense: "Camouflage",
      options: ["Spraying Chemicals", "Camouflage", "Sudden Movement"],
    ...
    },
    {
      ...
      defense: "Chemical", 
      options: ["Chemical", "Camouflage", "Bite"],
    ...
    },
    {
      ...
      defense: "Mimicry",
      options: ["Camouflage", "Mimicry", "Toxic chemical"],
    ...
    },
    {
      name: "Assassin bug",
      defense: "Venom",
      options: ["Sacrificing a leg", "Chemical", "Venom"],
    ...
    },
    {
      ...
      options: ["Camouflage", "Sacrificing a leg", "Mimicry"],
    ...
    },
    {
      ...
      options: ["Bite", "Camouflage", "Power in numbers"],
  ...
  marathi: [
    {
      ...
      defense: "छद्मावरण",
      options: ["अचानक हालचाल", "रासायनिक फवारणी", "छद्मावरण"],
    ...
    },
    {
      ...
      defense: "रासायनिक",
      options: ["चावा", "रासायनिक", "छद्मावरण"],
    ...
    },
    {
      ...
      defense: "मजबूत चावा",
      options: ["वाईट वास", "डंख", "मजबूत चावा"],
    ...
    },
    {
      name: "काडी किडा",
      defense: "पाय त्यागणे",
      options: ["छद्मावरण", "पाय त्यागणे", "अनुकरण"],
    ...
    },
    {
      name: "मधमाशी",
      defense: "डंख",
      options: ["संख्येत शक्ती", "चावा", "डंख"],
                        ...
                        <Button
                          ...
                          className={`w-full py-3 text-lg font-semibold rounded-full shadow-md transition duration-300 ease-in-out transform hover:scale-105
                            ${selectedAnswer === option
                              ? option === insects[language][currentPosition].defense
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-6 text-center">
                    <Button
                      ...
                      className="bg-green-600 hover:bg-green-700 text-white text-lg font-semibold py-2 px-6 rounded-full shadow-md transition duration-300 ease-in-out transform hover:scale-105"
                    >
      ...
      <Dialog open={showExitConfirmation} onOpenChange={setShowExitConfirmation}>
        <DialogContent className="sm:max-w-[425px] bg-gradient-to-r from-green-300 to-green-500 text-white border border-green-200 rounded-lg">
          ...
          <DialogFooter className="flex justify-end space-x-2">
            <Button onClick={() => setShowExitConfirmation(false)} variant="outline" className="bg-white text-green-800 hover:bg-green-100">
              {language === 'english' ? 'Cancel' : 'रद्द करा'}
            </Button>
            <Button onClick={confirmExit} variant="destructive" className="bg-red-600 hover:bg-red-700">
