...
// Extend DialogPortalProps to include className and ref
interface DialogPortalProps extends DialogPrimitive.DialogPortalProps, React.RefAttributes<HTMLDivElement> {
